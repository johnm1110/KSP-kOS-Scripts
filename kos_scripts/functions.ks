...
declare function InsertionBurn {
	...
	local transferSemiMajorAxis to (radiusA + radiusB) / 2. // semi-major axis of transfer ellipse
	local vInitialA to SQRT(BODY:MU / radiusA ).
	local vTransferA to SQRT(BODY:MU * (2 / radiusA - 1 / transferSemiMajorAxis)).
